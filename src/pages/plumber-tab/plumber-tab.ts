...
import { OffersPage } from '../plumber-app/offers/offers';

/**
 * Generated class for the PlumberTabPage page.
 *
...
@Component({
  selector: 'page-plumber-tab',
  templateUrl: 'plumber-tab.html',
})
export class PlumberTabPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public serve:MyserviceProvider)
  {
      ...
      this.plumber_data = this.navParams.get('data');
      console.log(this.plumber_data);
