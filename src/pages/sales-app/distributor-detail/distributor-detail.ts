...
export class DistributorDetailPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public service:MyserviceProvider,public loadingCtrl: LoadingController,public popoverCtrl: PopoverController, public constant:ConstantProvider) 
  {
    
    this.imageUrl = constant.VisitingCardURL;
  ...
  editNetwork(id, type)
  {
    if(type == '3')
    {
      this.navCtrl.push(AddDealerPage,{'type':3,'dr_id':id});
    }
    else
    {
