...
export class AddDistributionPage {
  ...
  data1:any=[];
  order_data:any = [];
  addDistributorValidation:any = false;
  ...
  { 
    ...
    if(this.addDistributorValidation == false)
    {
      this.addDistributorValidation = true;
